...
## this example is not relevant as the data is not in the repository and doesnt shown how to geolocate
localities <- df %>%
...
## TODO are all these libraries needed here? else load them quietly at the beggining of the chapter and point to the origin of key functions when appropriated
library(data.table)
library(dplyr)
library(ggplot2)
...
Carex$data$day <- ifelse(is.na(Carex$data$day), 
                       ...
                       Carex$data$day)
#it creates month data that is currently lacking from the bioatlas API
