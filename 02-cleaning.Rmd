...
## TODO are all these libraries needed here? else load them quietly at the begining of the chapter and point to the origin of key functions when appropiated
library(data.table)
library(dplyr)
library(ggplot2)
