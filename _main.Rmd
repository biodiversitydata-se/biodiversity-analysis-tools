...
Carex <- fread(list.files("./data/BDcleaner_Scripts/Example/Downloads/ignored data/cyperaceae/",
                          pattern = ".csv",
                          full.names = TRUE), encoding =  "UTF-8")

Carex$ID <- paste0("car-",1:nrow(Carex))
save(Carex ,file = "./data/BDcleaner_Scripts/Example/Downloads/ignored data/Cyperacea_SWE.data")
```
...
```{r, warning=FALSE, error=FALSE, message=FALSE}
library(openxlsx)
SpeciesNames <- read.xlsx("./data/BDcleaner_Scripts/Example/matchCarex.xlsx")
...
save(Carex, unUseful, file = "./data/BDcleaner_Scripts/Example/Downloads/ignored data/Cyperacea_SWE.data")
```
