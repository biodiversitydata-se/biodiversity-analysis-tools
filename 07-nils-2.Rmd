# Query data from NILS: blueberry and mountain violet occurrence in the alpine region
...
Following with NILS data we will now illustrate another example, this time from the report Skog & Mark 2015 [@naturvårdsverket2015]. In this example we reproduce the analys done in the first chapter with the aim to compare presence of two species at different altitudes in the mountain range.
